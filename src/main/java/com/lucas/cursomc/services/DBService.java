...
public class DBService {
	...
	@Autowired
	private CategoriaRepository categoriaReposioty;
	@Autowired
	private ProdutoRepository produtoReposioty;
	@Autowired
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		categoriaReposioty.save(Arrays.asList(cat1,cat2,cat3,cat4,cat5,cat6,cat7));
		produtoReposioty.save(Arrays.asList(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","lucasrcunha01@gmail.com","36378912377",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null,"Ana Costa","lucas_cunha925@hotmail.com","73451164094",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("91234567","93838393"));
		
		Endereco e1 = new Endereco(null,"Rua Flores", "300", "Apto 303","Jardim","38220834",cli1,c1);
		Endereco e2 = new Endereco(null,"Avenida Matos", "105", "Sala 800","Centro","38777012",cli1,c2);
		Endereco e3 = new Endereco(null,"Avenida Floriano", "1005", null,"Centro","38777012",cli2,c2);
